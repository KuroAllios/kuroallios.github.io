  ...
  $("form#contact-form").submit(function () {
    ...
    if (
      ...
      $.post($(this).attr("action"), formInput, function (data) {
        $(".mail-message")
          .removeClass("not-visible-message")
          .addClass("visible-message");
      });
    }
    //stay page
    return false;
